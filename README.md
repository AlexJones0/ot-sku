...
This repository is meant to be linked into the upstream `opentitan` repository (the [`earlgrey_1.0.0`](https://github.com/lowRISC/opentitan/tree/earlgrey_1.0.0) branch) by overriding the `ot_provisioning_exts` module.
